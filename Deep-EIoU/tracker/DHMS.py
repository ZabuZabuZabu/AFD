...
class DHMS(object):
    def __init__(self, args, frame_rate=30):
        ...
        # self.buffer_size = int(frame_rate / 30.0 * args.track_buffer)#ずべて保存するので使わない
    ...
    def update(self, output_results, embedding):
        ...
        for iteration in range(num_iteration):
            ...
            ious_dists[ious_dists > self.proximity_thresh] = 1.0

            if self.args.with_reid:
                emb_dists = matching.embedding_distance(strack_pool, detections)
                emb_dists[emb_dists > self.appearance_thresh] = 1.0
                dists = 2/((1/ious_dists)+(1/emb_dists))#new association
            else:
                dists = ious_dists
        ...
        # """ Step 5: Update state"""#すべて保存するのでいらない

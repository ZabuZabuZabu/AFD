...
def imageflow_demo(predictor, output_dir, args):
    if args.img_folder:
    ...
    if args.save_result:
        det_file = osp.join(output_dir, f"{video_name}.npy")
        np.save(det_file, all_detections)
...
def main(exp, args):
    ...
    imageflow_demo(predictor, output_dir, args)
